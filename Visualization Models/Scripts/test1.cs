...
public class ReadQuaternionCSV1 : MonoBehaviour
{
    ...
    {
        using (StreamReader strReader = new StreamReader("D:\\CAVE_Lab_Internship\\python\\ypred.csv"))
        {
            ...
            while (!endOfFile)
            {
                ...
                if (data_values.Length >= 4)
                {
                    ...
                    /*Quaternion rotateQuat = new Quaternion(0.0f, 0.717f, 0.00f, 0.69f);
                    Quaternion rotateQuatX = new Quaternion(0f, 0f, 0.8f, 0.69f);*/
                    Quaternion myQuaternion = new Quaternion(w, -z, y, x);
